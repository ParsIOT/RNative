...
export default class track_class extends Component {
 ...
 _sendToServer=(position)=>{                                                                   // the function to send tracking
  ...
  .then((r2)=>JSON.parse(r2)).then((r3)=>{
      var temp1=r3.BayesGuess.split(",")                                                           // split x and y
 ...
 _buttonPressed(){
     ...
     {
       return <Button onPress={()=>this._sendToServer("210,210")}  title="Press Me"/>
     }
   }
